...
function Navbar() {
  ...
  return (
    <>
      <div
       className={` max-w-screen-2xl container mx-auto md:px-20 px-6 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-30 ${
        sticky
...
{authUser ? (
              ...
              <div className="">
                <a
                  className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer btn-outline"
